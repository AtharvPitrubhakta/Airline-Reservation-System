...
public class Journey_Details extends JFrame{  //Forth
	...
	ReservationDetails.setForeground(Color.CYAN);
	...
	String[] items1 =  {"India", "China", "Russia", "United States","Australia","Saudi Arabia"};
	JComboBox comboBox = new JComboBox(items1);
	comboBox.setBounds(150, 100, 150, 27);
	add(comboBox);
		
		
	String[] items2 =  {"India", "China", "Russia", "United States","Australia","Saudi Arabia"};
